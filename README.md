...
# Hedgesats - An [LNbits](https://github.com/lnbits/lnbits) Extension
...
1. run `./updateExtensionName.sh hedgesats:<yourextensionname> Hedgesats:<yourExtensionName> Hedgesats:<YourExtensionName>` (to replace all variations)

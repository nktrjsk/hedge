...
# Hedge - An [LNbits](https://github.com/lnbits/lnbits) Extension
...
1. run `./updateExtensionName.sh hedge:<yourextensionname> Hedge:<yourExtensionName> Hedge:<YourExtensionName>` (to replace all variations)
